...
set EXPAT_LIBRARY=%OSRMDEPSDIR%\lib\libexpat.lib
set EXPAT_INCLUDE_DIR=%OSRMDEPSDIR%\include\expat.h
set BZIP2_LIBRARIES=%OSRMDEPSDIR%\lib\libbz2.lib
set BZIP2_INCLUDE_DIR=%OSRMDEPSDIR%\include\bzlib.h
set LUA_LIBRARIES=%OSRMDEPSDIR%\lib\lua5.3.5.lib
set LUA_INCLUDE_DIR=%OSRMDEPSDIR%\include\lua.hpp
set ZLIB_LIBRARIES=%OSRMDEPSDIR%\lib\libz.lib
set ZLIB_INCLUDE_DIR=%OSRMDEPSDIR%\include\zlib.h
